...
Shadowheart::Math::vec3::vec3(const float& x, const float& y, const float& z)
    : _v{x, y, z} {}
float& Shadowheart::Math::vec3::operator[](const int& i) { return _v[i]; }

Shadowheart::Math::vec4::vec4(const float& x, const float& y, const float& z,
                              const float& w)
    : _v{x, y, z, w} {}
...
Shadowheart::Math::ivec3::ivec3(const int& x, const int& y, const int& z)
    : _v{x, y, z} {}
int& Shadowheart::Math::ivec3::operator[](const int& i) { return _v[i]; }

Shadowheart::Math::ivec4::ivec4(const int& x, const int& y, const int& z,
                                const int& w)
    : _v{x, y, z, w} {}
