...
vec3 vec3::operator+(const vec3& a) { return vec3(_v[0] + a._v[0], _v[1] + a._v[1], _v[2] + a._v[2]); }
...
vec4 vec4::operator+(const vec4& a) { return vec4(_v[0] + a._v[0], _v[1] + a._v[1], _v[2] + a._v[2], _v[3] + a._v[3]); }
